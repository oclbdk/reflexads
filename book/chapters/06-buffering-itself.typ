...
holds itself up — now for the whole structure rather than a face. This is what it means, at last, for a
reflexad to be one-step idempotent into a flat space.
